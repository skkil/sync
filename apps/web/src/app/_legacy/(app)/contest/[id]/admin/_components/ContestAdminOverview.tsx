...
interface ContestAdminOverviewProps {
  id: string;
}

export default function ContestAdminOverview({
  id,
}: ContestAdminOverviewProps) {
  ...
  if (contest.type !== ProviderType.CONTEST || !contest.isMaintainer) {
    notFound();
  }
