...
export default function FollowingTags() {
  ...
  const { data, isPending, isError } = useGetFollowedTags(
    handle,
    { page: String(page), size: PAGE_SIZE },
  ...
  return (
    <section className="space-y-3">
      <h2 className="text-lg font-semibold">{t('following.title')}</h2>
      ...
      <TagList
        ...
        isPending={isPending}
        isError={isError}
        emptyMessage={t('following.empty')}
